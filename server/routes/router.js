...
router.get('/', (req, res) => {
    ...
    let queryText = 'SELECT * FROM "tasks" ORDER BY ("priority");';  // Database Create: tasks ; Koala had priority can take out
...
router.post('/',  (req, res) => {
  ...
  let queryText = `INSERT INTO "tasks" ("Task", "Completed", "Delete") 
                   VALUES ($1, $2, $3)`;
